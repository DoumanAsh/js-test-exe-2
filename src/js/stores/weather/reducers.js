...
import {REQUEST_WEATHER, RECEIVE_WEATHER, RESET_WEATHER, ENTER_CITY, UNKNOWN_CITY, RESET_SEARCH} from './actions.js'
...
function city(state='Use search box!', action) {
    switch (action.type) {
        ...
        case RESET_SEARCH: return action.name
        default: return state;
    }
}

function weather(state={city_id: null, city: null, time: null, today: null}, action) {
    switch (action.type) {
